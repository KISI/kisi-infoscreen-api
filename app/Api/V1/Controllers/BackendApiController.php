...
class BackendApiController extends Controller
{
    ...
    public function cloneEvents(Request $request)
    {
        ...
        foreach ($events as $event) {
            ...
            $newevent->start = $newevent->start->setDate((int)$newdate->format("Y"),(int)$newdate->format("n"),(int)$newdate->format("j"));
            $newevent->end = $newevent->end->setDate((int)$newdate->format("Y"),(int)$newdate->format("n"),(int)$newdate->format("j"));
            $newevent->save();
        }
